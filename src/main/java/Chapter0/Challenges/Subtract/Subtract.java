...
public class Subtract {
    /**
     * Let's continue our calculator app, but make it a bit better.
     *
     ...
     * depends on this use case. (For instance, you count the number of puppies at your pet store with int / whole
